...
def Action_Down_Left(Current_Node):
    New_Node=[0,0]
    New_Node[0]=Current_Node[0]-1
    New_Node[1]=Current_Node[1]+1
    Cost=1.41
...
def Action_Up_Left(Current_Node):
    New_Node=[0,0]
    New_Node[0]=Current_Node[0]-1
    New_Node[1]=Current_Node[1]-1
    Cost=1.41
...
def Action_Up_Right(Current_Node):
    New_Node=[0,0]
    New_Node[0]=Current_Node[0]+1
    New_Node[1]=Current_Node[1]-1
    Cost=1.41
...
def Action_Down_Right(Current_Node):
    New_Node=[0,0]
    New_Node[0]=Current_Node[0]+1
    New_Node[1]=Current_Node[1]+1
    Cost=1.41
